...
public class PeakCreateBudget extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_dining.setText(String.valueOf((int) currentSummary.getDiningBudget()));
        ...
        et_groceries.setText(String.valueOf((int) currentSummary.getGroceriesBudget()));
        ...
        et_shopping.setText(String.valueOf((int) currentSummary.getShoppingBudget()));
        ...
        et_living.setText(String.valueOf((int) currentSummary.getLivingBudget()));
        ...
        et_entertainment.setText(String.valueOf((int) currentSummary.getEntertainmentBudget()));
        ...
        et_education.setText(String.valueOf((int) currentSummary.getEducationBudget()));
        ...
        et_beauty.setText(String.valueOf((int) currentSummary.getBeautyBudget()));
        ...
        et_transportation.setText(String.valueOf((int) currentSummary.getTransportationBudget()));
        ...
        et_health.setText(String.valueOf((int) currentSummary.getHealthBudget()));
        ...
        et_travel.setText(String.valueOf((int) currentSummary.getTravelBudget()));
        ...
        et_pet.setText(String.valueOf((int) currentSummary.getPetBudget()));
        ...
        et_other.setText(String.valueOf((int) currentSummary.getOtherBudget()));
